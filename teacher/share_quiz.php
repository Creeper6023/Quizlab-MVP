...
$quiz = $db->single("SELECT * FROM quizzes WHERE id = ? AND created_by = ?", [$quiz_id, $teacher_id]);
if (!$quiz) {
...
", [ROLE_TEACHER, ROLE_ADMIN, $teacher_id]);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['share_quiz'])) {
        ...
        if (!$user) {
            ...
            ", [$quiz_id, $teacher_id, $shared_with_id]);
            ...
            if ($existingShare) {
                ...
                $db->query("
                    ...
                    WHERE quiz_id = ? AND shared_by_id = ? AND shared_with_id = ?
                ", [$permission_level, $quiz_id, $teacher_id, $shared_with_id]);
                ...
                $db->query("
                    ...
                    VALUES (?, ?, ?, ?)
                ", [$quiz_id, $teacher_id, $shared_with_id, $permission_level]);
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= BASE_URL ?>/teacher/quizzes.php" class="btn btn-outline-primary">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 text-primary"><i class="fas fa-share-alt me-2"></i>Share with Others</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 text-primary"><i class="fas fa-users-cog me-2"></i>Currently Shared With</h5>
                </div>
                <div class="card-body">
