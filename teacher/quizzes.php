    ...
    <div class="row">
        <div class="col-12">
            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex">
                    <button class="btn btn-success" id="create-quiz-btn" data-bs-toggle="modal" data-bs-target="#createQuizModal">
                    ...
                    <?php if (count($quizzes) > 0): ?>
                        <div class="row">
                            <?php foreach ($quizzes as $quiz): ?>
                                <?php $quiz_hash_id = $quiz['hash_id'] ?? $quiz['id']; ?>
                                    ...
                                    <div class="card h-100 shadow-sm">
                                        ...
                                        <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="btn-group">
                                                ...
                                                <?php endif; ?>
                                                <a href="<?= BASE_URL ?>/teacher/share_quiz.php?id=<?= $quiz_hash_id ?>" class="btn btn-sm btn-outline-secondary">
                                ...
                                <div class="card h-100 shadow-sm border-primary border-opacity-25">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="card-title"><?= htmlspecialchars($quiz['title']) ?></h5>
                                            <span class="text-muted"><small>By: <?= htmlspecialchars($quiz['owner_name']) ?></small></span>
                                        </div>
                                    ...
                                    <div class="card-footer bg-white border-top">
                                        <div class="btn-group w-100">
                                            <?php if ($quiz['permission_level'] === 'view' || $quiz['permission_level'] === 'edit' || $quiz['permission_level'] === 'full'): ?>
                                                <a href="<?= BASE_URL ?>/teacher/view_quiz.php?id=<?= $quiz_hash_id ?>" class="btn btn-sm btn-outline-primary">
                                                    <i class="fas fa-eye me-1"></i> View
                                                </a>
                                            <?php endif; ?>
                                            
                                            <?php if ($quiz['permission_level'] === 'edit' || $quiz['permission_level'] === 'full'): ?>
                                                <a href="<?= BASE_URL ?>/teacher/edit_quiz.php?id=<?= $quiz_hash_id ?>" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-edit me-1"></i> Edit
                                                </a>
                                            <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.location.search.includes('showCreate')) {
